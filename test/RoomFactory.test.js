...
describe('RoomFactory', function () {
    ...
    describe('createRoom', function () {
        ...
        it('can pause createRoom', async function () {
            ...
            await this.roomFactory.createRoom({ from: roomOwner1, value: amount }).should.be.rejectedWith(Error)
        })

        it('only the factory owner can pause createRoom', async function () {
            await this.roomFactory.pause({ from: roomOwner1 }).should.be.rejectedWith(Error)
        ...
        it('only the factory owner can unpause createRoom', async function () {
            ...
            await this.roomFactory.createRoom({ from: roomOwner1, value: amount }).should.be.fulfilled
        })
    })
}) */